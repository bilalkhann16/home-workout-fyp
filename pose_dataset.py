...
def get_dataflow(path, is_train, img_path=None):
    ...
    if is_train:
        ...
        ds = PrefetchData(ds, 100, multiprocessing.cpu_count() * 1)
...
def _get_dataflow_onlyread(path, is_train, img_path=None):
    print ("\n\n\n start dataflow", path, is_train, img_path=None)
    ds = CocoPose(path, img_path, is_train)  # read data from lmdb
    ds = MapData(ds, read_image_url)
    ds = MapData(ds, pose_to_img)
...
if __name__ == '__main__':
    ...
    df = _get_dataflow_onlyread('/Users/bilalk/Desktop/FYP/unofficial-implement-of-openposet_v2/COCO/annotations', True, '/Users/bilalk/Desktop/FYP/unofficial-implement-of-openposet_v2/COCO')
    # df = _get_dataflow_onlyread('/Users/bilalk/Desktop/FYP/unofficial-implement-of-openposet_v2/COCO/annotations/', True)
...
#     # df = get_dataflow('/data/public/rw/coco/annotations', True, '/data/public/rw/coco/')
#     df = _get_dataflow_onlyread('/Users/bilalk/Desktop/FYP/unofficial-implement-of-openposet_v2/COCO/annotations', True, '/data/public/rw/coco/')
#     # df = get_dataflow('/root/coco/annotations', False, img_path='http://gpu-twg.kakaocdn.net/braincloud/COCO/')
